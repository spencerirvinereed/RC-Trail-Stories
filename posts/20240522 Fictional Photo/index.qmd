...
I was looking at a photo of that famous bend of the Colorado River by Page, Arizona.

The sun was setting and the sky was colored with threatening clouds.

`Horse Shoe Bend` , <https://pagelakepowellhub.com/horseshoe-bend/>

Commented that the photo wasn't an accurate representation of the location.\
—-\
A person overheard my comment and said the photo accurately depicted the location.\
As we parted, both clung to original convictions.

------------------------------------------------------------------------

At times, there is a need to enhance the photo with available tools.\
However, if one starts pulling in elements not present at the time the photo was taken, is that an accurate representation?
...
Perhaps it is not fiction or non-fiction

Nor authenticity or enhancement

But personal or public that we need to consider.

Develop the gift and share the gift.

Accept the gift and enjoy it.
