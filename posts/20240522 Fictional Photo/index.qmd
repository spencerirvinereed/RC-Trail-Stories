...
I commented that the photo didn't represent the location.\
\
...
There is a need to enhance the photo with available tools.\
...
Fiction vs Non-Fiction as defined by the Cambridge Dictionary^[<https://dictionary.cambridge.org/us/dictionary/english/non-fiction>]

> writing that is about real events and facts, rather than stories that have been invented

And Grammarly says^[<https://www.grammarly.com/blog/fiction-vs-nonfiction/#:~:text=Fiction%20refers%20to%20literature%20that,people%2C%20information%2C%20or%20events.>],
...
In olden days, up to 1970s, prior to widespread availability of refrigeration, a handcart (리어카^[<https://www.wikiwand.com/ko/%EB%A6%AC%EC%96%B4%EC%B9%B4>], 손수래) full of Kimchi^[See Appendix].

I remember following the handcart home as the older gentleman pulled the 배추 (cabbage) that would sustain the family.
...
However, as long as, the work is kept private and not shared, there is no need to worry about whether the work will be in public domain, copied and re-generated as AI produced product.
